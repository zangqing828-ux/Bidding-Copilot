...
const rawMethods = {
  ...
  events: {
    ...
    database: {
      onStatus: createContractEntry({
        ...
        output: { type: 'void' },
        errors: ['WEB_BRIDGE_EVENT_UNSUBSCRIBE_ERROR'],
      }),
    },
    ai: {
  ...
  knowledgeBase: {
    ...
    deleteFolder: createContractEntry({ status: 'implemented', owner: 'knowledge', workPackage: 'WP-A', contractRef: 'knowledgeBase.deleteFolder' }),
    deleteDocument: createContractEntry({ status: 'implemented', owner: 'knowledge', workPackage: 'WP-A', contractRef: 'knowledgeBase.deleteDocument' }),
    moveDocument: createContractEntry({ status: 'implemented', owner: 'knowledge', workPackage: 'WP-A', contractRef: 'knowledgeBase.moveDocument' }),
    ...
    retryDocument: createContractEntry({ status: 'implemented', owner: 'knowledge', workPackage: 'WP-A', contractRef: 'knowledgeBase.retryDocument' }),
