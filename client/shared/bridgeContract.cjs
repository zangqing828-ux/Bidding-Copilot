...
const rawMethods = {
  ...
  tasks: {
    ...
    startGlobalFactsGeneration: implementedBridgeContract({
      ...
      input: [contractArg('payload', 'StartGlobalFactsGenerationInput', { properties: {} })],
      output: 'BackgroundTaskState',
      errors: ['TASK_INVALID_INPUT', 'TASK_CONFLICT', 'TASK_INPUT_CHANGED', 'TASK_ACCEPTANCE_ABORTED', 'TASK_INTERRUPTED_BY_RESTART'],
    }),
    ...
    pauseContentGeneration: implementedBridgeContract({
      ...
      input: [],
      output: 'BackgroundTaskState',
      errors: ['TASK_CONFLICT', 'TASK_INPUT_CHANGED', 'TASK_PAUSE_TIMEOUT', 'TASK_INTERRUPTED_BY_RESTART'],
    }),
